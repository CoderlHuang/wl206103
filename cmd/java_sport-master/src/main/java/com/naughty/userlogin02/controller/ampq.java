...
public class ampq {
    ...
    private static String accessKey = "LTAI5tSmwx4TFAs9wpxncv3D";
    private static String accessSecret = "FUknOFZM7xEK29YsyLurLbtjNYGUvn";
    private static String consumerGroupId ="nVkbPJaDRWoIqcY8TQ8q000100";

    //iotInstanceId：实例ID。若是2021年07月30日之前（不含当日）开通的公共实例，请填空字符串。
    private static String iotInstanceId = "iot-06z00futcg4oenw";
    ...
    private static String host = "1610332304712764.iot-amqp.cn-shanghai.aliyuncs.com";
